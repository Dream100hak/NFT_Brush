...
public class CustomBrushEditor
{
    ...
    public static void PlaceCube(Vector3 position)
    {
        ...
        if (CustomLayerEditor.ED.SelectedLayerIds.Any() == false)
            return;

        foreach(int selectedLayerId in CustomLayerEditor.ED.SelectedLayerIds)
        {
            ...
            CustomLayerEditor.LayerObjects[selectedLayerId].GetComponent<LayerData>().HasChanged = true;
